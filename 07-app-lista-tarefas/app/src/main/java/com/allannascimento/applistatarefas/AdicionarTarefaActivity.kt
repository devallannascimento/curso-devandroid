...
import com.allannascimento.applistatarefas.databinding.ActivityAdicionarTarefaBinding
...
class AdicionarTarefaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null){
            ...
            binding.textAddTarefa.text = "Alterar tarefa"
    ...
    private fun editar(tarefa: Tarefa) {
        ...
        val tarefaAtualizar = Tarefa(
            tarefa.idTarefa, descricao, dataCriacao = "default"
        )
